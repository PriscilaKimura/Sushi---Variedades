var MENU = {
    "sushis": [
        {
            "id": "sushi-assortment-platter",
            "img": "./img/cardapio/sushis/Sushi-Assortment-Platter.jpg",
            "name": "Sushi Assortment Platter",
            "dsc": "A variety of fresh sushi including nigiri and sashimi",
            "price": 190.95
        },
        {
            "id": "tempura-udon-noodle-bowl",
            "img": "./img/cardapio/sushis/tempura-udon-noodle-bowl.jpg",
            "name": "Tempura Udon Noodle Bowl",
            "dsc": "Udon noodles in a savory broth with crispy tempura on top",
            "price": 45.90
        },
        {
            "id": "spicy-tuna-roll",
            "img": "./img/cardapio/sushis/spicy-tuna-roll.jpg",
            "name": "Spicy Tuna Roll",
            "dsc": "Tuna, spicy mayo, and cucumber rolled in sushi rice and seaweed",
            "price": 40.60
        },
        {
            "id": "sashimi-deluxe-platter",
            "img": "./img/cardapio/sushis/sashimi-deluxe-platter.jpg",
            "name": "Sashimi Deluxe Platter",
            "dsc": "An assortment of fresh sashimi slices, including tuna, salmon, and yellowtail",
            "price": 80.75
        },
        {
            "id": "vegetable-temaki-hand-roll",
            "img": "./img/cardapio/sushis/vegetable-temaki-hand-roll.jpg",
            "name": "Vegetable Temaki Hand Roll",
            "dsc": "A hand-rolled cone of sushi rice, avocado, cucumber, and other vegetables",
            "price": 60.95
        },
        {
            "id": "dragon-roll",
            "img": "./img/cardapio/sushis/dragon-roll.jpg",
            "name": "Dragon Roll",
            "dsc": "Eel, avocado, and cucumber rolled in sushi rice, topped with avocado slices",
            "price": 48.90
        },
        {
            "id": "chirashi-bowl",
            "img": "./img/cardapio/sushis/chirashi-bowl.jpg",
            "name": "Chirashi Bowl",
            "dsc": "Assorted sashimi over a bowl of sushi rice",
            "price": 150.98
        },
        {
            "id": "Gyoza",
            "img": "./img/cardapio/sushis/Gyoza.jpg",
            "name": "Gyoza",
            "dsc": "Indulge in the irresistible texture and flavor of Gyoza, delightful dumplings typically filled with pork, cabbage, leek, and other savory ingredients. Served steamed or pan-fried to perfection, our Gyoza is a burst of Asian flavors that will undoubtedly satisfy your palate.",
            "price": 21.99
        },
        {
            "id": "tuna-nigiri",
            "img": "./img/cardapio/sushis/tuna.jpg",
            "name": "Tuna Nigiri",
            "dsc": "Fresh tuna slices served over bite-sized beds of sushi rice",
            "price": 30.50
        },
        {
            "id": "shrimp-nigiri",
            "img": "./img/cardapio/sushis/shrimp-nigiri.jpg",
            "name": "Shrimp Nigiri",
            "dsc": "Juicy shrimp perched on compact rice beds, lightly seasoned",
            "price": 35.90
        },
        {
            "id": "salmon-onigiri",
            "img": "./img/cardapio/sushis/salmon-onigiri.jpg",
            "name": "Salmon Onigiri",
            "dsc": "Classic rice triangle wrapped in seaweed, filled with savory grilled salmon",
            "price": 88.50
        },
        {
            "id": "ume-shiso-onigiri",
            "img": "./img/cardapio/sushis/ume-shiso-onigiri.jpg",
            "name": "Ume Shiso Onigiri",
            "dsc": "Delicious onigiri with a flavorful combination of pickled plum (ume) and shiso leaf",
            "price": 40.90
        }
    ],
    "burgers": [
    ...
    "saladas": [
        {
            "id": "caesar-salad",
            "img": "./img/cardapio/saladas/caesar-salad.jpg",
            "name": "Caesar Salad",
            "dsc": "Fresh romaine lettuce, croutons, parmesan cheese, and Caesar dressing",
            "price": 25.90
        },
        {
            "id": "greek-salad",
            "img": "./img/cardapio/saladas/greek-salad.jpg",
            "name": "Greek Salad",
            "dsc": "Mixed greens, tomatoes, cucumbers, feta cheese, olives, and Greek dressing",
            "price": 23.90
        },
        {
            "id": "caprese-salad",
            "img": "./img/cardapio/saladas/caprese-salad.jpg",
            "name": "Caprese Salad",
            "dsc": "Fresh tomatoes, mozzarella cheese, basil, olive oil, and balsamic glaze",
            "price": 20.50
        },
        {
            "id": "spinach-and-strawberry-salad",
            "img": "./img/cardapio/saladas/Spinach-and-Strawberry.jpg",
            "name": "Spinach & Strawberry",
            "dsc": "Baby spinach, strawberries, goat cheese, almonds, and raspberry vinaigrette",
            "price": 40.90
        },
        {
            "id": "quinoa-chickpea-salad",
            "img": "./img/cardapio/saladas/quinoa-chickpea-salad.jpg",
            "name": "Quinoa Chickpea Salad",
            "dsc": "Quinoa, chickpeas, cherry tomatoes, cucumber, and lemon-tahini dressing",
            "price": 35.90
        },
        {
            "id": "cobb-salad",
            "img": "./img/cardapio/saladas/cobb-salad.jpg",
            "name": "Cobb Salad",
            "dsc": "Mixed greens, grilled chicken, bacon, avocado, blue cheese, and ranch dressing",
            "price": 56.90
        },
        {
            "id": "grilled-vegetable-salad",
            "img": "./img/cardapio/saladas/Grilled-Vegetable-Salad.jpg",
            "name": "Grilled Vegetable Salad",
            "dsc": "Assorted grilled vegetables, mixed greens, feta cheese, and balsamic vinaigrette",
            "price": 30.00
        },
        {
            "id": "avocado-chicken-salad",
            "img": "./img/cardapio/saladas/avocado-chicken-salad.jpg",
            "name": "Avocado Chicken Salad",
            "dsc": "Grilled chicken breast, mixed greens, cherry tomatoes, avocado, and cilantro-lime dressing",
            "price": 60.90
        },
        {
            "id": "simple-green-salad",
            "img": "./img/cardapio/saladas/simple-green-salad.jpg",
            "name": "Salada Verde Simples",
            "dsc": "Mix de folhas verdes frescas com molho de sua escolha",
            "price": 25.90
        },
        {
            "id": "tomato-cucumber-salad",
            "img": "./img/cardapio/saladas/tomato-cucumber-salad.jpg",
            "name": "Salada de Tomate e Pepino",
            "dsc": "Tomates e pepinos frescos com tempero leve",
            "price": 48.90
        },
        {
            "id": "classic-caesar-salad",
            "img": "./img/cardapio/saladas/classic-caesar-salad.jpg",
            "name": "Caesar Salad Clássica",
            "dsc": "Alface romana, croutons, parmesão e molho Caesar tradicional",
            "price": 40.90
        },
        {
            "id": "fresh-fruits-salad",
            "img": "./img/cardapio/saladas/fresh-fruits-salad.jpg",
            "name": "Salada de Frutas Frescas",
            "dsc": "Seleção de frutas frescas da estação",
            "price": 25.50
        }
    ]
}
